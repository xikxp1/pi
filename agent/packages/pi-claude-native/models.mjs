export function buildModels(catalog, overrides = {}) {
  return catalog.filter(m => m.id.startsWith('claude-')).map(m => ({
    id: m.id, name: `${m.name} (Claude Max)`, reasoning: m.reasoning,
    input: m.input, thinkingLevelMap: m.thinkingLevelMap,
